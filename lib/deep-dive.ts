...
export function generateDeepDiveMessage(payload: SurveyPayload): GeneratedMessage {
  ...
  let nextStep = "Convidar para uma conversa rápida pelo WhatsApp.";
  let urgencyScore = 2;
  ...
  return {
    ...
    headline,
    whatsappText,
    deepDiveSummary: deepDiveOpen || "A pessoa respondeu ao diagnóstico e pode receber uma abordagem inicial baseada no perfil detectado.",
    nextStep,
    urgencyScore,
    interestLevel,
  };
