param(
  [string]$OutputName = "jornada-personal-extrema-bloco-3-automacao.zip"
)
...
$TempDir = Join-Path $OutputDir "jornada-personal-extrema-bloco-3-automacao"
...
Write-Host "Depois de anexar o ZIP aqui, remova a pasta _exports antes de rodar npm run build:" -ForegroundColor Yellow
